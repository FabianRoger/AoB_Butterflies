...
# for about 14% of the Site x segment x dates combinations, the perc vegetation does not add up to 100
...
2) some cover adds to >100 --> chack manually
...
##export
```{r}
save(RMO, RMO_spat, file = "clean_data.RData")
```
